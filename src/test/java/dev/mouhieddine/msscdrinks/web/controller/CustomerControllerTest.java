...
class CustomerControllerTest {
  ...
  void getCustomerById() throws Exception {
    ...
    mockMvc.perform(get(CustomerController.BASE_URL + "/" + validCustomer.getId().toString()).accept(MediaType.APPLICATION_JSON))
  ...
  void createCustomer() throws Exception {
    ...
    CustomerDto savedDto = CustomerDto.builder().id(UUID.randomUUID()).name("Mouhieddine Sabir").build();
    String drinkDtoJson = objectMapper.writeValueAsString(customerDto);
