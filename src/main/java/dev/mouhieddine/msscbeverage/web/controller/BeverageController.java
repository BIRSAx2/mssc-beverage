...
public class BeverageController {
  ...
  @PostMapping
  public ResponseEntity<HttpHeaders> createBeverage(@PathVariable BeverageDto beverageDto) {
  ...
  @PutMapping({"/{id}"})
  public ResponseEntity<HttpStatus> updateBeverage(@PathVariable UUID id, @PathVariable BeverageDto beverageDto) {
